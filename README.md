...
[![Build Status](https://dev.azure.com/cwoz/python-flask-tutorial/_apis/build/status/cwoz117.python-sample-vscode-flask-tutorial?branchName=master)](https://dev.azure.com/cwoz/python-flask-tutorial/_build/latest?definitionId=1&branchName=master)
